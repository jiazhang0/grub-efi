...
// File Open Modes
#define GRUB_EFI_FILE_MODE_READ		0x0000000000000001UL
#define GRUB_EFI_FILE_MODE_WRITE	0x0000000000000002UL
#define GRUB_EFI_FILE_MODE_CREATE	0x8000000000000000UL

// File Attributes
#define GRUB_EFI_FILE_READ_ONLY		0x0000000000000001UL
#define GRUB_EFI_FILE_HIDDEN		0x0000000000000002UL
#define GRUB_EFI_FILE_SYSTEM		0x0000000000000004UL
#define GRUB_EFI_FILE_RESERVED		0x0000000000000008UL
#define GRUB_EFI_FILE_DIRECTORY		0x0000000000000010UL
#define GRUB_EFI_FILE_ARCHIVE		0x0000000000000020UL
#define GRUB_EFI_FILE_VALID_ATTR	0x0000000000000037UL
